...
export const Inicio = () => {
    ...
    return (
        <InicioEstilo id="secao1" className="secao">
        ...
        <div>
            <img className="avatar" src="https://media.licdn.com/dms/image/v2/D5603AQF1PpEBOLGicQ/profile-displayphoto-shrink_800_800/profile-displayphoto-shrink_800_800/0/1704422733211?e=1731542400&v=beta&t=W1Ia38EdCEnIwPQM0XY89ewhWbeZwtVa5_lVtQ3zSWg" alt="Avatar" />
        </div>
        </InicioEstilo>
    )
}